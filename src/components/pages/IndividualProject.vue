<template>
  <div class="cont px-6 xl:px-16 py-10 flex flex-col xl:grid grid-cols-2">
      ...
      <transition name='second'>
        <div v-show="secondTransition" class="second ">
            ...
            <div class="github flex items-center justify-center mt-4">
                <a :href="projObject.githubLink" class="text-text-color underline font-bold" target="_blank">View more on {{ projObject.nameOfProject }}</a>
