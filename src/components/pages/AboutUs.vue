<template>
    ...
    <div class="first-view  h-height90 w-screen">
        <Banner nameofpage="About Us" />
        <div class="first-view-bottom z-30  relative ">
            <div class="features grid grid-cols-1  xl:grid-cols-3 absolute xl:-top-28 w-full gap-5 px-6 py-4 xl:px-16">
                <div class="quality h-height30 xl:h-height40 flex flex-col p-2 items-center justify-center shadow-sm">
                    <div class="icon mb-2">  
                        <svg  version="1.1" viewBox="-38 0 512 512.00142" class="h-full w-full">
                            <g id="surface1">
                    ...
                    <p class="text-base text-gray-900 text-center">With our proven expertise in sourcing the best items, be rest assured that each selected piece is of the highest quality attainable. </p>
                </div>
                <div class="quality h-height30 xl:h-height40 flex flex-col p-2 items-center justify-center shadow-sm">
                    <div class="icon mb-2">
                        <svg class="h-full w-full" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
                            <g id="_16-express" data-name="16-express">
                            <g id="glyph"><rect x="276" y="12" width="104" height="48" rx="12"/>
                            <path d="M136,188H56a12,12,0,0,0,0,24h80a12,12,0,0,0,0-24Z"/>
                            <path d="M132,296a12,12,0,0,0-12-12H40a12,12,0,0,0,0,24h80A12,12,0,0,0,132,296Z"/>
                            <path d="M128,332H72a12,12,0,0,0,0,24h56a12,12,0,0,0,0-24Z"/>
                            <path d="M132,248a12,12,0,0,0-12-12H16a12,12,0,0,0,0,24H120A12,12,0,0,0,132,248Z"/>
                            <path d="M328,272V136c-74.991,0-136,61.009-136,136s61.009,136,136,136,136-61.009,136-136Z"/>
                    ...
                    <p class="text-base text-gray-900 text-center">Our delivery schedule is within 24 - 48 hours of payment and address confirmation.</p>
                </div>
                <div class="quality h-height30 xl:h-height40 flex flex-col p-2 items-center justify-center shadow-sm">
    ...
    <main class="px-6 xl:px-16 py-8  md:mt-0 items-center w-screen grid grid-cols-1 xl:grid-cols-2 gap-y-8">
        ...
        <div class="box  bg-red-500 p-5 ">
            ...
            <p class="mb-5 text-sm xl:text-base text-white text-justify ">Smooches is an online store that stocks on a variety of female lingerie, men, underwear, sleepwear, loungewear, swimwear, sex toys and scents
                at best prices.
                <br /> <br />
                The <b>goal</b> at SMOOCHES is to style everyone with the underwear that best flatters them.
            </p>
        </div>
...
.first-view-bottom .features > * {
  box-shadow: 1px 1px 1px rgba(168, 168, 168, 0.3);
