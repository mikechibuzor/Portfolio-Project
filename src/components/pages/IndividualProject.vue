<template>
  <div class="cont px-6 xl:px-16 py-10 flex flex-col xl:grid grid-cols-2">
      <div class="first mt-8 xl:mt-0 h-height70 col-span-1  ">
      ...
      <div class="second ">
          ...
          <h2 class="text-4xl font-bold my-4">{{ projObject.nameOfProject }}</h2>
          <p class="leading-relaxed text-gray-700 text-justify xl:mr-32 text-sm">{{ projObject.aboutProject }}
          </p>
          ...
          <div class="controls-container bg-white border w-full xl:w-4/5 px-4 py-6 flex justify-between shadow rounded mt-2">
              <div class="previous">
