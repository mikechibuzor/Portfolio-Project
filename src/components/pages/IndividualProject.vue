<template>
  <div class="cont px-16 py-10 grid grid-cols-2">
      ...
      <div class="second ">
          ...
          <div class="controls-container bg-white border w-4/5 px-4 py-6 flex justify-between shadow rounded mt-2">
              <div class="previous">
                  <p>Playroom application: <br />
                      Electronic app
                  </p>
              </div>
              <div class="next">
