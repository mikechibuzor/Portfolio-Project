<template>
  <div class="mt-8 flex flex-wrap ">
      <span @click="setFilter" class="bg-text-color dark:bg-green-500 shadow-sm    text-white rounded-xl px-3 xl:px-6 py-0.5 mr-4 mb-4 cursor-pointer" id="all">All</span>
